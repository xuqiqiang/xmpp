...
public class CustomEditText extends LinearLayout {
    ...
    public CustomEditText(Context context, AttributeSet attributeSet) {
        ...
        int mlayoutHeight = attrs.getDimensionPixelSize(
                R.styleable.CustomEditText_fab_layout_height, -1);

        if (mlayoutHeight != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mEditText
                    .getLayoutParams();
            params.height = mlayoutHeight;
            mEditText.setLayoutParams(params);
        }

        boolean isPassword = attrs.getBoolean(
                R.styleable.CustomEditText_fab_isPassword, false);
        if (isPassword) {
            mEditText
            ...
            CheckBox switch_eye = (CheckBox) (view
                    .findViewById(R.id.switch_eye));
        ...
        int mImeAction = attrs.getInt(R.styleable.CustomEditText_fab_imeAction,
                0);
        if (mImeAction == 1) {
        ...
        int mDrawable = attrs.getResourceId(
                R.styleable.CustomEditText_fab_drawable, 0);
        int mDrawablePadding = attrs.getDimensionPixelSize(
                R.styleable.CustomEditText_fab_drawablePadding, 0);
        if (mDrawable != 0) {
    ...
    public void dismissPopupPrompt() {
        if (mPopupPromptView != null && mPopupPromptView.isShowing()) {
